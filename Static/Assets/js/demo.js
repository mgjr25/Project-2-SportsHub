...
demo = {
    ...
    showNotification: function(from, align) {
        ...
        $.notify({
            icon: "nc-icon nc-app",
            message: "Welcome to NFL Sports Hub"
    ...
    buildtable:function() {
            ...
            $("#playertable").jsGrid({
                ...
                fields: [
                    { name: "player_name", type: "text",type: "text", width: "25%" },
                    { name:"current_team",type:"text",width:"25%"},
                    { name: "position", type: "text",width: "25%"},
                    { name:"current_salary", type: "text",width: "25%"}
